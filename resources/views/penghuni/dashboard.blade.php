    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow-sm p-6 rounded-xl">
            ...
            <div class="gap-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('penghuni.pengaduan.index') }}" class="group flex items-center gap-4 bg-gray-50/50 hover:bg-gray-50 p-4 border border-gray-100 rounded-xl transition">
                ...
                <a href="{{ route('penghuni.pengaduan.create') }}" class="group flex items-center gap-4 bg-gray-50/50 hover:bg-gray-50 p-4 border border-gray-100 rounded-xl transition">
            ...
            <div class="bg-white shadow-sm p-6 rounded-xl">
                ...
                @if ($tagihanAktif)
                    ...
                    <div class="flex items-center gap-3 mt-3">
                        <span class="font-bold text-primary text-2xl">Rp. {{ number_format($tagihanAktif->jumlah_tagihan, 0, ',', '.') }}</span>
                    ...
                    <div class="flex justify-between mt-4 text-sm">
                        ...
                        <span class="font-medium text-grayCustom-800">{{ \Illuminate\Support\Carbon::parse($tagihanAktif->tanggal_jatuh_tempo)->translatedFormat('d F Y') }}</span>
                    </div>
                    ...
                    <tbody class="divide-y divide-grayCustom-100">
                        @forelse ($riwayatPembayaran as $tagihan)
                            ...
                            <tr>
                                ...
                                <td class="py-4 pr-4">
                                    <p class="font-bold text-grayCustom-800">Rp. {{ number_format($tagihan->jumlah_tagihan, 0, ',', '.') }}</p>
                                    <p class="text-grayCustom-500">{{ \Illuminate\Support\Carbon::parse($tagihan->tanggal_jatuh_tempo)->translatedFormat('d F Y') }}</p>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-4 text-grayCustom-400 text-center">Belum ada riwayat pembayaran lain.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

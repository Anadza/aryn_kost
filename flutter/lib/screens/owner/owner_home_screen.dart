...
// Pastikan kamu mengimport warna ini jika ada di constants/theme kamu
// Jika mengambil dari file lain, tambahkan importnya. 
const Color primaryColor = Colors.blue; // Sesuaikan dengan kodemu
const Color bgColor = Color(0xFFF3F4F6); // Sesuaikan dengan kodemu
...
class _OwnerHomeScreenState extends State<OwnerHomeScreen> {
  ...
  void initState() { 
    super.initState(); 
    // Menggunakan endpoint yang sama untuk melihat data dashboard
    _dashFuture = DashboardService().fetchAdminDashboard(); 
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Owner hanya memantau, action notifikasi bisa disesuaikan atau dibiarkan kosong
      ...
      builder: (context, snap) {
        ...
        if (snap.hasError) {
          return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            ElevatedButton(
              onPressed: () => setState(() => _dashFuture = DashboardService().fetchAdminDashboard()), 
        ...
        return RefreshIndicator(
          onRefresh: () async { 
            setState(() => _dashFuture = DashboardService().fetchAdminDashboard()); 
            await _dashFuture; 
          },
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  // Stats cards responsive (Sama seperti Admin)
                  GridView.count(
                    shrinkWrap: true, 
